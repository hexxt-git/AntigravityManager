const ru = {
  ...
  settings: {
    ...
    cache: {
      ...
      description:
        'Очистите известные каталоги кэша Antigravity и Antigravity IDE, чтобы устранить ошибки входа или проверки версии.',
      ...
      warning: 'Закройте Antigravity перед очисткой, чтобы избежать заблокированных файлов.',
      cancel: 'Отмена',
    ...
    account: {
      ...
      antigravity_cli_executable: 'Исполняемый файл Antigravity CLI',
      antigravity_cli_executable_desc:
        'Путь к CLI agy. Патч проверки доступа применяется только к этому файлу.',
      antigravity_cli_executable_placeholder: 'Пример: C:\\Program Files\\Antigravity\\agy.exe',
      detect_antigravity_cli: 'Найти',
      agy_cli_detected: 'Antigravity CLI найден',
      agy_cli_detect_failed: 'Antigravity CLI не найден',
      agy_patch_desc:
        'Создаёт резервную копию CLI, проверяет единственное совпадение ARM64 или x86_64, применяет патч и повторно подписывает Mach-O в macOS.',
      agy_patch_action: 'Применить патч доступа',
      agy_patch_success: 'Antigravity CLI исправлен',
      agy_patch_already_applied: 'Патч уже применён',
      agy_patch_failed: 'Не удалось исправить Antigravity CLI',
      agy_patch_result:
        'Формат: {{format}}; архитектуры: {{architectures}}; резервная копия: {{backupPath}}',
      agy_patch_no_backup: 'не требуется',
  ...
  cloud: {
    ...
    'quota-window': {
      ...
      'weekly-bucket-unavailable': 'В сводке квоты нет распознаваемого недельного лимита.',
    },
    authDialog: {
    ...
    card: {
      ...
      liveLimitQuotaSnapshot: 'Снимок квоты всё ещё может показывать {{percentage}}%.',
  ...
  proxy: {
    ...
    'open-code': {
      ...
      'config-viewer-description': 'Предпросмотр конфигурации только для чтения',
