const en = {
  ...
  settings: {
    ...
    cache: {
      ...
      description:
        'Clear known Antigravity and Antigravity IDE cache directories to resolve login or version validation issues.',
      clear: 'Clear Antigravity Cache',
      dialogTitle: 'Clear Antigravity Cache?',
      dialogDescription: 'The following existing cache directories will be removed.',
      pathsLabel: 'Cache directories',
      noPaths: 'No known Antigravity cache directories were found.',
      warning: 'Close Antigravity before clearing its cache to avoid locked or recreated files.',
      cancel: 'Cancel',
      confirm: 'Clear Cache',
      clearing: 'Clearing...',
    ...
    account: {
      ...
      antigravity_cli_executable: 'Antigravity CLI executable',
      antigravity_cli_executable_desc:
        'Path to the agy CLI executable. Eligibility patching is restricted to this file.',
      antigravity_cli_executable_placeholder: 'Example: C:\\Program Files\\Antigravity\\agy.exe',
      detect_antigravity_cli: 'Detect',
      agy_cli_detected: 'Antigravity CLI detected',
      agy_cli_detect_failed: 'Antigravity CLI not found',
      agy_patch_desc:
        'Back up the CLI, verify a unique ARM64 or x86_64 eligibility pattern, apply the patch, and re-sign Mach-O files on macOS.',
      agy_patch_action: 'Apply eligibility patch',
      agy_patch_success: 'Antigravity CLI patched',
      agy_patch_already_applied: 'Patch already applied',
      agy_patch_failed: 'Unable to patch Antigravity CLI',
      agy_patch_result:
        'Format: {{format}}; architectures: {{architectures}}; backup: {{backupPath}}',
      agy_patch_no_backup: 'not required',
  ...
  cloud: {
    ...
    localImport: {
      ...
      resultDescription: 'The account list has been updated with the confirmed result.',
      ...
      validationErrors: {
        ...
        'network-failed': 'The account could not be verified because of a network error.',
      ...
      discoveryErrors: {
        ...
        'permission-denied': 'Permission to read the credential source was denied.',
      ...
      importErrors: {
        ...
        'identity-conflict': 'This credential conflicts with an existing account identity.',
    ...
    card: {
      ...
      liveLimitActiveTitle: 'The live upstream endpoint is temporarily unavailable.',
      liveLimitRecentTitle: 'The live upstream endpoint recently returned an error.',
      liveLimitQuotaSnapshot: 'The quota snapshot can still show {{percentage}}%.',
  ...
  proxy: {
    ...
    'open-code': {
      ...
      'custom-base-url': 'Custom Manager BaseURL',
