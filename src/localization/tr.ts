const tr = {
  ...
  settings: {
    ...
    cache: {
      ...
      description:
        'Oturum açma veya sürüm doğrulama sorunlarını gidermek için bilinen Antigravity ve Antigravity IDE önbellek klasörlerini temizleyin.',
      ...
      warning: 'Kilitli dosyaları önlemek için temizlemeden önce Antigravity uygulamasını kapatın.',
      cancel: 'İptal',
    ...
    account: {
      ...
      antigravity_cli_executable: 'Antigravity CLI çalıştırılabilir dosyası',
      antigravity_cli_executable_desc:
        'agy CLI yolu. Uygunluk yaması yalnızca bu dosyaya uygulanır.',
      antigravity_cli_executable_placeholder: 'Örnek: C:\\Program Files\\Antigravity\\agy.exe',
      detect_antigravity_cli: 'Algıla',
      agy_cli_detected: 'Antigravity CLI algılandı',
      agy_cli_detect_failed: 'Antigravity CLI bulunamadı',
      agy_patch_desc:
        'CLI dosyasını yedekler, tek bir ARM64 veya x86_64 kalıbını doğrular, yamayı uygular ve macOS’ta Mach-O dosyasını yeniden imzalar.',
      agy_patch_action: 'Uygunluk yamasını uygula',
      agy_patch_success: 'Antigravity CLI yamalandı',
      agy_patch_already_applied: 'Yama zaten uygulanmış',
      agy_patch_failed: 'Antigravity CLI yamalanamadı',
      agy_patch_result: 'Biçim: {{format}}; mimariler: {{architectures}}; yedek: {{backupPath}}',
      agy_patch_no_backup: 'gerekli değil',
