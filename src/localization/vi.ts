const vi = {
  ...
  settings: {
    ...
    cache: {
      ...
      description:
        'Xóa các thư mục bộ nhớ đệm Antigravity và Antigravity IDE đã biết để khắc phục lỗi đăng nhập hoặc xác thực phiên bản.',
    ...
    account: {
      ...
      antigravity_cli_executable: 'Tệp thực thi Antigravity CLI',
      antigravity_cli_executable_desc:
        'Đường dẫn đến CLI agy. Bản vá điều kiện chỉ được áp dụng cho tệp này.',
      antigravity_cli_executable_placeholder: 'Ví dụ: C:\\Program Files\\Antigravity\\agy.exe',
      detect_antigravity_cli: 'Phát hiện',
      agy_cli_detected: 'Đã phát hiện Antigravity CLI',
      agy_cli_detect_failed: 'Không tìm thấy Antigravity CLI',
      agy_patch_desc:
        'Sao lưu CLI, xác minh một mẫu ARM64 hoặc x86_64 duy nhất, áp dụng bản vá và ký lại tệp Mach-O trên macOS.',
      agy_patch_action: 'Áp dụng bản vá điều kiện',
      agy_patch_success: 'Đã vá Antigravity CLI',
      agy_patch_already_applied: 'Bản vá đã được áp dụng',
      agy_patch_failed: 'Không thể vá Antigravity CLI',
      agy_patch_result:
        'Định dạng: {{format}}; kiến trúc: {{architectures}}; bản sao lưu: {{backupPath}}',
      agy_patch_no_backup: 'không cần thiết',
